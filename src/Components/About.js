...
function About() {
  const [display] = useState([
    ...
    <div>
      <ul>
        <li>
          <RiLightbulbFlashFill className="list-style" />
          الإبداع
        </li>
      </ul>
      <ul >
        <li>
          <IoShieldCheckmarkSharp className="list-style"/>
          النزاهه
        </li>
      </ul>
      <ul>
        <li>
          <GiStaryu className="list-style"/>
          التميز
        </li>
      </ul>
      <ul>
        <li>
          <FaPeopleCarryBox className="list-style"/>
          التعاون
        </li>
      </ul>
      <ul>
        <li>
          <PiStepsBold className="list-style"/>
          التطور المستمر
        </li>
      </ul>
    </div>,
